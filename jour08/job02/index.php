...
<head>
    ...
    <title>Job 02 - Header avec Tailwind</title>
...
<body>
    ...
    <footer class="bg-gray-800 text-white p-4 mt-8">
        <ul class="flex justify-center space-x-4">
            ...
            <li><a href="index.php" class="hover:text-gray-300">Inscription</a></li>
            <li><a href="index.php" class="hover:text-gray-300">Connexion</a></li>
            <li><a href="index.php" class="hover:text-gray-300">Rechercher</a></li>
        </ul>
    </footer>
</body>
</html>